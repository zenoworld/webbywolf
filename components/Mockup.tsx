...
const Mockup = () => {
    return (
        <section className="w-full h-screen sm:h-[500px] bg-gray-200 flex flex-col sm:flex-row items-center justify-center relative pt-4 pl-4 lg:px-20">

            <div className="w-full sm:w-1/2 h-full flex flex-col items-start justify-center relative ">

                <div className="w-full sm:w-[70%] relative 0">
            ...
            <div className="w-full sm:w-1/2 h-full mt-4 sm:mt-0  relative pr-20 sm:pr-0">
                <Image
