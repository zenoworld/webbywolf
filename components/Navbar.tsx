...
const Navbar = () => {
  return (
    <header className="w-full py-4 px-4 md:px-10 lg:px-15 xl:px-20 flex items-center justify-between bg-white shadow-md relative">
      ...
      <div>
        <button className="bg-white text-[#222222] relative z-10 font-semibold px-5 py-2 rounded-sm hover:bg-[#e2e2e2] transition shadow-lg">
          Sign In
        </button>
      </div>
    </header>
