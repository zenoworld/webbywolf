    ...
    return <>
        ...
        <section className="section min-h-screen flex items-start justify-start md:items-center overflow-hidden">
            ...
            <div className="z-10 w-full h-full sm:w-1/2 text-white relative" >
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl mb-4 font-heading text-[#222] leading-tight  text-center sm:text-start">
                ...
                <p
                    className="
                text-sm md:text-md 
                w-full px-4 sm:px-0 sm:w-[80%] lg:w-full
                text-[#000000] text-center sm:text-start ">
